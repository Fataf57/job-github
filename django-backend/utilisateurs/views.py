...
def create_utilisateur(request):
    """Créer un utilisateur et envoyer un code de vérification par email."""
    serializer = UtilisateurSerializer(data=request.data)
    if serializer.is_valid():
        utilisateur = serializer.save()

        # Générer et sauvegarder le code si un email est fourni
        ...
        if email:
            ...
            try:
                ...
                pass  # En dev le backend console affiche l'email dans le terminal
